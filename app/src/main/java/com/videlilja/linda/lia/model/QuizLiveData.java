...
/*            case C_ASIA:
            ...
            case C_OCEANIA:
                ...
                capitalsOceania.add(new Quiz(context.getString(R.string.fl_oc_australia_au), context.getString(R.string.ca_oc_australia_au), R.drawable.crown, context.getString(R.string.capital_question)));
                capitalsOceania.add(new Quiz(context.getString(R.string.ca_oc_cook_islands_ck), context.getString(R.string.ca_oc_cook_islands_ck), R.drawable.crown, context.getString(R.string.capital_question)));
                capitalsOceania.add(new Quiz(context.getString(R.string.ca_oc_east_timor_tl), context.getString(R.string.ca_oc_east_timor_tl), R.drawable.crown, context.getString(R.string.capital_question)));
                capitalsOceania.add(new Quiz(context.getString(R.string.ca_oc_fiji_fj), context.getString(R.string.ca_oc_fiji_fj), R.drawable.crown, context.getString(R.string.capital_question)));
                capitalsOceania.add(new Quiz(context.getString(R.string.ca_oc_indonesia_id), context.getString(R.string.ca_oc_indonesia_id), R.drawable.crown, context.getString(R.string.capital_question)));

                capitalsOceania.add(new Quiz(context.getString(R.string.ca_oc_kiribati_ki), context.getString(R.string.ca_oc_kiribati_ki), R.drawable.crown, context.getString(R.string.capital_question)));
                capitalsOceania.add(new Quiz(context.getString(R.string.ca_oc_the_marshall_islands_mh), context.getString(R.string.ca_oc_the_marshall_islands_mh), R.drawable.crown, context.getString(R.string.capital_question)));
                capitalsOceania.add(new Quiz(context.getString(R.string.ca_oc_micronesia_fm), context.getString(R.string.ca_oc_micronesia_fm), R.drawable.crown, context.getString(R.string.capital_question)));
                capitalsOceania.add(new Quiz(context.getString(R.string.ca_oc_nauru_nr), context.getString(R.string.ca_oc_nauru_nr), R.drawable.crown, context.getString(R.string.capital_question)));
                capitalsOceania.add(new Quiz(context.getString(R.string.ca_oc_new_zealand_nz), context.getString(R.string.ca_oc_new_zealand_nz), R.drawable.crown, context.getString(R.string.capital_question)));

                capitalsOceania.add(new Quiz(context.getString(R.string.ca_oc_niue_nu), context.getString(R.string.ca_oc_niue_nu), R.drawable.crown, context.getString(R.string.capital_question)));
                capitalsOceania.add(new Quiz(context.getString(R.string.ca_oc_palau_pw), context.getString(R.string.ca_oc_palau_pw), R.drawable.crown, context.getString(R.string.capital_question)));
                capitalsOceania.add(new Quiz(context.getString(R.string.ca_oc_papua_new_guinea_pg), context.getString(R.string.ca_oc_papua_new_guinea_pg), R.drawable.crown, context.getString(R.string.capital_question)));
                capitalsOceania.add(new Quiz(context.getString(R.string.ca_oc_samoa_ws), context.getString(R.string.ca_oc_samoa_ws), R.drawable.crown, context.getString(R.string.capital_question)));
                capitalsOceania.add(new Quiz(context.getString(R.string.ca_oc_the_solomon_islands_sb), context.getString(R.string.ca_oc_the_solomon_islands_sb), R.drawable.crown, context.getString(R.string.capital_question)));

                capitalsOceania.add(new Quiz(context.getString(R.string.ca_oc_tonga_to), context.getString(R.string.ca_oc_tonga_to), R.drawable.crown, context.getString(R.string.capital_question)));
                capitalsOceania.add(new Quiz(context.getString(R.string.ca_oc_tuvalu_tv), context.getString(R.string.ca_oc_tuvalu_tv), R.drawable.crown, context.getString(R.string.capital_question)));
                capitalsOceania.add(new Quiz(context.getString(R.string.ca_oc_vanuatu_vu), context.getString(R.string.ca_oc_vanuatu_vu), R.drawable.crown, context.getString(R.string.capital_question)));
